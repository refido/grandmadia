			...
			<div className="row">
				...
				<div className="col-5 text-center">
					<div class="form-floating mb-3">
						<input type="nama" class="form-control" id="floatingInput" placeholder="Nama Lengkap" value={name} onChange={handleChangeName}></input>
					...
					<button type="button" class="btn btn-light w-100 mb-4 text-primary" onClick={handleRegister}>
						Daftar
					</button>
					<p>
