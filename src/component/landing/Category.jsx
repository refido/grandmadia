			...
			<div className="row">
				<div className="col-6">
					<div className="row">
						...
						<div className="col-3">
							<Link to={`category/Ebook`} style={{ textDecoration: "none" }}>
								<div className="icon text-center">
				...
				<div className="col-6">
					<div className="row">
						<div className="col-3">
							<Link to={`category/Gramedia-Academy`} style={{ textDecoration: "none" }}>
								<div className="icon text-center">
						...
						<div className="col-3">
							<Link to={`category/Print-On-Demand`} style={{ textDecoration: "none" }}>
								<div className="icon text-center">
						...
						<div className="col-3">
							<Link to={`category/Stationary`} style={{ textDecoration: "none" }}>
								<div className="icon text-center">
						...
						<div className="col-3">
							<Link to={`category/Mainan`} style={{ textDecoration: "none" }}>
								<div className="icon text-center">
