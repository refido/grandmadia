...
const Content = () => {
	...
	const getAccount = async () => {
		try {
			await axios.get("https://grandemedia-clone-server.herokuapp.com/accounts", { email, password });
			setEmail(this.email);
				...
				<div className="col-5 text-center">
					...
					<div className="row" style={{ marginTop: "5px", marginBottom: "25px" }}>
						<div style={{ width: "100%", height: "15px", borderBottom: "1px solid grey", textAlign: "center" }}>
							<span style={{ fontSize: "10px", backgroundColor: "#FFFFFF", padding: "0 10px" }}>Akun Lainnya</span>
						</div>
					</div>
					<div>
						<button type="button" className="btn border border-dark w-100 mb-4 text-primary">
